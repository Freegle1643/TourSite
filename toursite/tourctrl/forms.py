...
class RegistrationForm(forms.Form):
    ...
    utag = forms.CharField(widget=forms.TextInput(attrs=dict(required=True, max_length=250)),
        label="utag", required=False)
    usign = forms.CharField(widget=forms.TextInput(attrs=dict(required=True, max_length=30)),
        label="usign", required=False)
